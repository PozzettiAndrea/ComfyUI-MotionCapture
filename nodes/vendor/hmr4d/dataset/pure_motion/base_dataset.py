...
from ...utils.geo.hmr_global import get_c_rootparam, get_R_c2gv
from ...utils.net_utils import get_valid_mask, repeat_to_max_len, repeat_to_max_len_dict
from ...utils.geo_transform import compute_cam_angvel, apply_T_on_points, project_p2d, cvt_p2d_from_i_to_c
...
class BaseDataset(Dataset):
    ...
    def _process_data(self, data, idx):
        ...
        if False:  # render
            from ...utils.wis3d_utils import convert_motion_as_line_mesh
